                    ...
                    {data?.tags.map((tag) => {
                        ...
                        return (
                            <Pressable
                                ...
                                key={tag.id}
                                className={cn(
                                    'h-10 min-w-[30%] max-w-[calc(100%/3-3rem)] flex-row items-center justify-center gap-2 rounded-lg border border-teal-400 bg-white',
...
export const AddNoteTagsSelectScreenNextButton = () => {
    ...
    return (
        <Pressable onPress={handlePress} className={cn('flex-row items-center rounded-full  px-5 py-2')}>
