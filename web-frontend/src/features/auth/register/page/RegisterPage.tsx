...
export default function RegisterPage({ className, ...props }: React.ComponentProps<typeof Card>) {
    return (
        <>
            ...
            <div className="mt-4 text-muted-foreground *:[a]:hover:text-primary text-center text-xs text-balance *:[a]:underline *:[a]:underline-offset-4">
                En vous inscrivant, vous acceptez nos <a href="#">Conditions d'utilisation</a> et <a href="#">Politique de confidentialité</a>.
            </div>
        </>
    );
}
