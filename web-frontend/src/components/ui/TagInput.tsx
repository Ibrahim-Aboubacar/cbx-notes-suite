...
import { type Tag, TagInput as TagInputComponent } from "emblor";

export type TInputTag = Tag;
export default function TagInput({ ...props }: Omit<ComponentProps<typeof TagInputComponent>, "activeTagIndex" | "setActiveTagIndex">) {
    ...
    return (
        <TagInputComponent
            ...
            {...(props as ComponentProps<typeof TagInputComponent>)}
